...
/*
 * Connect a student's class name from the students table
 * to the real class ID from the classes table.
 *
 * Example:
 *
 * students.class_name = "Grade 7"
 * classes = [
 *   { id: "1", name: "Grade 7" }
 * ]
 *
...
export function SchoolProvider({
  ...
  const loadData = async () => {
    try {
      ...
      /*
       * Use real database classes when they exist.
       * Otherwise keep the existing sample classes.
       */
      const actualClasses =
      ...
      /*
       * First convert students from database format.
       */
      ...
      /*
       * Then connect every student to the real class ID.
       *
       * This fixes the Grade 7 / Grade 8 / Grade 9
       * report-card class matching problem.
       */
